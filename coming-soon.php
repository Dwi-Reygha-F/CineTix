...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>CineTix | Coming Soon</title>
...
<div class="container-fluid service overflow-hidden pt-5">
    <div class="container py-5">
        <div class="section-title text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="sub-style">
                <h5 class="sub-title text-primary px-3">Coming Soon</h5>
            </div>
            <h1 class="display-5 mb-4">Film pilihan segera hadir untuk menghibur harimu!</h1>
        </div>
        <div class="row g-4">
                    ...
                    <div class="service-item">
                        <div class="service-inner">
                            <div class="service-img">
                                <img src="<?php echo $row['banner']; ?>" class="img-fluid w-100 rounded" alt="Image">
                            </div>
